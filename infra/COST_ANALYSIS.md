...
> Phase 1 완료 (2026-03-29): **~$278/월**
> 최종 목표: **~$65/월** (Phase 3 완료 시)
...
### ✅ Phase 1: 좀비 리소스 삭제 — **완료 (2026-03-29)**

이 리소스들은 **사용 중인 것이 없음**. 당장 삭제해도 서비스에 영향 없음.

| 항목 | 월 절감 | 삭제 위험도 | 상태 |
|------|---------|------------|------|
| 서울 좀비 EBS 19개 (930GB gp2) | $106.02 | **없음** (미연결) | ✅ 삭제 완료 |
| 서울 좀비 CLB 4개 | $74.40 | **없음** (인스턴스 0개) | ✅ 삭제 완료 |
| 싱가포르 좀비 NAT GW + EIP | $43.90 + $3.72 | **없음** (처리량 0) | ✅ 삭제 완료 |
| 도쿄 좀비 EBS 2개 (250GB gp2) | $28.50 | **없음** (미연결) | ✅ 삭제 완료 |
| 싱가포르 좀비 EBS 2개 (250GB gp2) | $28.50 | **없음** (미연결) | ✅ 삭제 완료 |
| **소계** | **$285.04/월** | | |

> 세금 포함 시 약 **$320/월** 절감됨 (다음 달 청구서부터 반영)

### ⏳ Phase 2: EC2 다운사이징 — $145/월 추가 절감 (팀 검토 후 진행)
...
### ⏳ Phase 3: t4g.nano 이전 — $68/월 추가 절감 (팀 검토 후 진행)

eth-bridge, bsc-bridge를 ARM64 Graviton2 t4g.nano로 교체 + EBS 100GB → 8GB 축소.

| 항목 | 현재 | Phase 3 후 | 절감 |
|------|------|-----------|------|
| eth-bridge EC2 | t3.small $15.18 | t4g.nano $3.80 | -$11.38 |
| bsc-bridge EC2 | t3.small $15.18 | t4g.nano $3.80 | -$11.38 |
| eth-bridge EBS | 100GB gp2 $11.40 | 8GB gp3 $0.73 | -$10.67 |
| bsc-bridge EBS | 100GB gp3 $9.12 | 8GB gp3 $0.73 | -$8.39 |
| **소계** | | | **~$42/월** |

> ARM64 Docker 이미지: `bridge/Dockerfile.arm64` 준비 완료
> SQLite 바이너리: ARM64 musl 빌드 대응 완료

### ⏳ Phase 4 (선택): operation 인스턴스 통합 — $15/월 추가 절감
...
| 항목 | 비용 |
|------|------|
| EC2 4개 (현행 m6i.large×2 + t2.medium×2) | $205.68 |
| EBS 연결 볼륨 4개 | $22.22 |
| KMS | $6.00 |
...
### Phase 3 완료 후 (t4g.nano 이전)

| 항목 | 비용 |
|------|------|
| t4g.nano × 2 (eth-bridge, bsc-bridge) | $7.60 |
| t3.small × 2 (operation-instance × 2) | $30.36 |
| EBS 8GB×2 + 8GB×2 (gp3) | $2.92 |
| KMS | $6.00 |
| Public IPv4 4개 | $14.88 |
| CloudWatch | $1.03 |
| Tax (~10%) | ~$6 |
...
| 구분 | Jan 2026 | Phase 1 ✅ | Phase 2 | Phase 3 |
|------|----------|-----------|---------|---------|
| 월 비용 | $611.80 | ~$278 | ~$115 | ~$69 |
| 연 비용 | $7,342 | ~$3,336 | ~$1,380 | ~$828 |
| 절감액 | — | $334/월 | $497/월 | $543/월 |
| 절감률 | — | 55% | 81% | 89% |

> **Phase 1 완료 (2026-03-29)**: 좀비 리소스 전량 삭제, 다음 달 청구서부터 $334/월 절감 반영
