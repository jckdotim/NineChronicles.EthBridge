...
#
# 월 절감 효과:
#   - 서울 EBS 19개 (930GB gp2):      106.02달러/월
#   - 서울 CLB 4개:                    74.40달러/월
#   - 싱가포르 NAT GW + EIP:           47.62달러/월
#   - 도쿄 EBS 2개 (250GB gp2):        28.50달러/월
#   - 싱가포르 EBS 2개 (250GB gp2):    28.50달러/월
#   ─────────────────────────────────────────────
#   합계 (세전):                       285.04달러/월
#   Tax 포함 예상:                    ~320달러/월
#
...
# ---------------------------------------------------------------------------
# PHASE A: ap-northeast-2 (서울) — 좀비 EBS 19개 (930GB gp2, 106.02달러/월)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PHASE B: ap-northeast-2 (서울) — 좀비 CLB 4개 (74.40달러/월)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PHASE C: ap-southeast-1 (싱가포르) — NAT Gateway + EIP (47.62달러/월)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PHASE D: ap-northeast-1 (도쿄) — 좀비 EBS 2개 (28.50달러/월)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# PHASE E: ap-southeast-1 (싱가포르) — 좀비 EBS 2개 (28.50달러/월)
# ---------------------------------------------------------------------------
...
if [[ "$DRY_RUN" == "true" ]]; then
  ...
  echo "    서울 EBS 930GB:      106.02달러/월"
  echo "    서울 CLB 4개:         74.40달러/월"
  echo "    싱가포르 NAT+EIP:     47.62달러/월"
  echo "    도쿄 EBS 250GB:       28.50달러/월"
  echo "    싱가포르 EBS 250GB:   28.50달러/월"
  echo "    ─────────────────────────────"
  echo "    세전 합계:           285.04달러/월"
  echo "    Tax 포함 예상:       ~320달러/월"
  echo ""
  echo "  다음 단계:"
